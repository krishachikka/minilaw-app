...
import 'package:minilaw/src/features/authentication/screen/level/level3/quiz_screen.dart';
    ...
    return Scaffold(
      body: Stack(
        ...
        children: [
          ...
          GestureDetector(
            onTap: () => {Get.to(VideoPlayerWidget(videoPath: 'assets/videos/shelly.mp4',ontap: () => Get.to(() => QuizScreen())))},
