              ...
              GestureDetector(
                onTap: () {
                  showInfoPopup(context,
                      "In India, environmental laws safeguard natural resources and ecosystems. They regulate pollution, waste, and land use to ensure sustainability. These laws empower citizens to protect the environment and hold polluters accountable.");
                },
                child: Image(
